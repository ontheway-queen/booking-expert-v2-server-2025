...
const verteilRequest_1 = __importDefault(require("../../lib/flight/verteilRequest"));
...
const verteilApiEndpoints_1 = __importDefault(require("../../miscellaneous/endpoints/verteilApiEndpoints"));
const verteilFlightUtils_1 = require("../../lib/flight/verteilFlightUtils");
class VerteilFlightService extends abstract_service_1.default {
    ...
    FlightSearchService(_a) {
        return __awaiter(this, arguments, void 0, function* ({ booking_block, reqBody, search_id, dynamic_fare_supplier_id, }) {
            ...
            const AirShoppingRS = yield this.request.postRequest(verteilApiEndpoints_1.default.FLIGHT_SEARCH_ENDPOINT, AirShoppingRQ, airlineCodesCsv
                ...
                try {
                    ...
                    const FormattedFlights = yield Promise.all(Associations.map((Association) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        const FLightInfo = (_a = data.DataLists.FlightList) === null || _a === void 0 ? void 0 : _a.Flight.find((item) => {
                            var _a, _b;
                            const flightKeyMatch = item.FlightKey ===
                        ...
                        if (FLightInfo === null || FLightInfo === void 0 ? void 0 : FLightInfo.Journey) {
                            ...
                            flightElapsedTime =
                                luxon_1.Duration.fromISO(FlightDuration).as('minutes');
                        }
                    ...
                    (Association, AssociationIndex) => {
                        ...
                        (Segment, SegmentIndex) => {
                            ...
                            (OfferPrice) => {
                                ...
                                const travelerRef = OfferPrice.RequestedDate.Associations[0]
                                ...
                                if (OfferPriceSegment &&
                                    OfferPriceSegment.BagDetailAssociation) {
                                    const CarryOnReferences = // this is hand baggage
                                     OfferPriceSegment.BagDetailAssociation
                                        .CarryOnReferences;
                                    const CheckedBagReferences = OfferPriceSegment.BagDetailAssociation
                                        ...
                                        if (filteredBagAllowance) {
                                            ...
                                            if (firstBaggage &&
                                                ...
                                                if (firstBaggage.WeightAllowance) {
                                                    const UOM = firstBaggage.WeightAllowance.MaximumWeight[0]
                                                        .UOM;
                    ...
                    const FormattedPassengers = Offer.PricedOffer.OfferPrice.map((OfferPrice) => {
                        ...
                        const FormattedPassenger = {
                            ...
                            fare: {
                                ...
                                total_fare: Number(PriceDetail.TotalAmount.SimpleCurrencyPrice.value) *
                                    api_currency,
                            },
                        };
                        return FormattedPassenger;
                    ...
                    // ticket last date
                    const [ticket_last_date, ticket_last_time] = new flightUtils_1.default().utcToLocalDateTime(`${(_b = Offer.TimeLimits) === null || _b === void 0 ? void 0 : _b.OfferExpiration.DateTime}Z`);
                    // refundable or not
                    let refundable;
                    {
                        const PenaltyRefs = [
                        ...
                        if ((PenaltyRefs === null || PenaltyRefs === void 0 ? void 0 : PenaltyRefs.length) && Penalty) {
                            const matched = Penalty.filter((item) => PenaltyRefs.includes(item.ObjectKey) &&
                    ...
                    if (route_type === flightConstant_1.ROUTE_TYPE.DOMESTIC) {
                        ...
                        partial_payment = yield this.Model.PartialPaymentRuleModel(this.trx).getPartialPaymentCondition({
                            flight_api_name: flightConstant_1.VERTEIL_API,
                            airline: airlineCode,
                    ...
                    const FormattedResponse = {
                        ...
                        booking_block,
                        api: flightConstant_1.VERTEIL_API,
                        api_name: flightConstant_1.VERTEIL_API_NAME,
                        partial_payment,
                        price_changed: false,
    ...
    FlightRevalidateResFormatter(_a) {
        return __awaiter(this, arguments, void 0, function* ({ reqBody, oldData, dynamic_fare_supplier_id, response, route_type, }) {
                        ...
                        (OfferPrice) => {
                            ...
                            if (OfferPriceSegment &&
                                ...
                                const CheckedBagReferences = OfferPriceSegment.BagDetailAssociation
                                    .CheckedBagReferences;
                                if (CheckedBagReferences) {
                                    const filteredBagAllowance = (_d = (_c = DataLists.CheckedBagAllowanceList) === null || _c === void 0 ? void 0 : _c.CheckedBagAllowance) === null || _d === void 0 ? void 0 : _d.filter((item) => CheckedBagReferences.includes(item.ListKey));
                                    if (filteredBagAllowance) {
                                        const firstBaggage = filteredBagAllowance[0];
                                        if (firstBaggage &&
                                            firstBaggage.PieceAllowance &&
                            ...
                            const FormattedPassenger = {
                                type: TravelerInfo.PTC.value,
                                count: ((_e = reqBody.PassengerTypeQuantity.find((PTQ) => PTQ.Code === TravelerInfo.PTC.value)) === null || _e === void 0 ? void 0 : _e.Quantity) || 0,
                                cabin_code: (_f = OfferPriceSegment.ClassOfService.MarketingName) === null || _f === void 0 ? void 0 : _f.CabinDesignator,
                                cabin_type: (_g = OfferPriceSegment.ClassOfService.MarketingName) === null || _g === void 0 ? void 0 : _g.value,
                                booking_code: (_h = OfferPriceSegment.ClassOfService.Code) === null || _h === void 0 ? void 0 : _h.value,
                                available_seat: (_k = (_j = Association.AssociatedService) === null || _j === void 0 ? void 0 : _j.SeatAssignment) === null || _k === void 0 ? void 0 : _k.length,
                                meal_code: undefined,
                                meal_type: undefined,
                                available_break: undefined,
                                available_fare_break: undefined,
            ...
            //=== Last Time Check ==//
            {
                ...
                if (TimeLimits) {
                    const [ticket_last_date, ticket_last_time] = new flightUtils_1.default().utcToLocalDateTime(TimeLimits.Payment.DateTime + 'Z');
            ...
            //=== Refundable Check ==//
            {
                ...
                const PenaltyRefs = [
                    ...new Set((_b = PricedFlightOffer[0].OfferPrice.map((OP) => { var _a; return (_a = OP.FareDetail) === null || _a === void 0 ? void 0 : _a.FareComponent.map((FC) => { var _a; return (_a = FC.FareRules) === null || _a === void 0 ? void 0 : _a.Penalty.refs; }); })
                        .flat(10)) === null || _b === void 0 ? void 0 : _b.filter((PR) => PR !== undefined)),
                ];
                // const PenaltyRefs =
                //   response.PricedFlightOffers.PricedFlightOffer[0].OfferPrice[0]
                //     .FareDetail?.FareComponent[0].FareRules?.Penalty.refs;
                const Penalty = (_c = response.DataLists.PenaltyList) === null || _c === void 0 ? void 0 : _c.Penalty;
                if (PenaltyRefs && Penalty) {
                    const matched = Penalty === null || Penalty === void 0 ? void 0 : Penalty.filter((item) => PenaltyRefs.includes(item.ObjectKey) &&
                        item.RefundableInd !== undefined);
                    if (matched.length > 0) {
                        refundable = matched.every((p) => p.RefundableInd === true);
                    }
  ...
  `;
                ...
                PassengerDocument: [
                    {
                        ...
                        Type: 'PT',
                        CountryOfIssuance: ((_b = countries.find((cn) => cn.id == passenger.nationality)) === null || _b === void 0 ? void 0 : _b.iso) ||
                            'BD',
                        CountryOfResidence: ((_c = countries.find((cn) => cn.id == passenger.nationality)) === null || _c === void 0 ? void 0 : _c.iso) ||
                            'BD',
    ...
    FlightBookService(_a) {
        return __awaiter(this, arguments, void 0, function* ({ search_id, flight_id, passengers, }) {
            ...
            const countries = yield this.Model.CommonModel().getCountry({
            ...
            if (paymentTimeLimit === '' && ((_c = Order === null || Order === void 0 ? void 0 : Order.OrderItems) === null || _c === void 0 ? void 0 : _c.OrderItem[0].TimeLimits)) {
                ...
                if (!timeLimit)
                    timeLimit =
                        (_e = Order.OrderItems.OrderItem[0].TimeLimits.PriceGuaranteeTimeLimits) === null || _e === void 0 ? void 0 : _e.Timestamp;
                if (timeLimit)
        ...
        return __awaiter(this, arguments, void 0, function* ({ pnr, airlineCode, passengers, }) {
            ...
            try {
                ...
                let paymentTimeLimit = (Order === null || Order === void 0 ? void 0 : Order.TimeLimits)
                    ...
                    : '';
                if (paymentTimeLimit === '' &&
                    ((_c = Order === null || Order === void 0 ? void 0 : Order.OrderItems) === null || _c === void 0 ? void 0 : _c.OrderItem[0].TimeLimits)) {
                    let timeLimit = (_d = Order.OrderItems.OrderItem[0].TimeLimits.PaymentTimeLimit) === null || _d === void 0 ? void 0 : _d.Timestamp;
                    if (!timeLimit)
                        timeLimit =
                            (_e = Order.OrderItems.OrderItem[0].TimeLimits.PriceGuaranteeTimeLimits) === null || _e === void 0 ? void 0 : _e.Timestamp;
                ...
                if (TicketDocInfo) {
                    flightTickets = passengers.map((Pax) => {
                        ...
                        const paxRef = (_c = (_b = OrderRetrieveRS.Response) === null || _b === void 0 ? void 0 : _b.Passengers.Passenger.find((VerteilPax) => VerteilPax.PassengerIDInfo.PassengerDocument[0].ID.toUpperCase() ===
                            passportID)) === null || _c === void 0 ? void 0 : _c.ObjectKey;
    ...
    TicketIssueService(_a) {
        return __awaiter(this, arguments, void 0, function* ({ pnr, airlineCode, oldFare, passengers, }) {
            ...
            try {
                ...
                const { OrderReshopRS, OrderReshopRQ } = yield this.OrderReshop({
                    pnr,
                    airlineCode,
                });
                {
                ...
                if (TicketDocInfo) {
                    flightTickets = passengers.map((Pax) => {
                        var _a, _b, _c, _d;
                        const passportID = (_a = Pax.passport_number) === null || _a === void 0 ? void 0 : _a.toUpperCase();
                        const paxRef = (_c = (_b = OrderChangeRS.Response) === null || _b === void 0 ? void 0 : _b.Passengers.Passenger.find((VerteilPax) => VerteilPax.PassengerIDInfo.PassengerDocument[0].ID.toUpperCase() ===
                            passportID)) === null || _c === void 0 ? void 0 : _c.ObjectKey;
                        const TicketInfo = TicketDocInfo.find((TDI) => TDI.PassengerReference[0] === paxRef);
                        const TicketDocument = (_d = TicketInfo === null || TicketInfo === void 0 ? void 0 : TicketInfo.TicketDocument) === null || _d === void 0 ? void 0 : _d[0];
                ...
                return {
                    ...
                    data: flightTickets,
                    ticket_status: flightConstant_1.FLIGHT_TICKET_ISSUE,
                };
            }
            catch (error) {
