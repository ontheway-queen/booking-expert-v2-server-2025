...
class AgentFlightBookingSupportService extends abstract_service_1.default {
    ...
    checkAgentDirectTicketIssuePermission(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const agency_details = yield agencyModel.checkAgency({ agency_id: payload.agency_id });
    ...
    updateDataAfterTicketIssue(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            tracking_data.push({
                ...
                description: `Ticket ${payload.status === flightConstent_1.FLIGHT_TICKET_IN_PROCESS ? 'has been issued' : 'is in process'}. Issued by ${payload.issued_by_type}`,
            });
            ...
            if (payload.due > 0) {
                ...
                yield moneyReceiptModel.createMoneyReceipt({
                    mr_number: yield lib_1.default.generateNo({ trx: this.trx, type: constants_1.GENERATE_AUTO_UNIQUE_ID.money_receipt }),
