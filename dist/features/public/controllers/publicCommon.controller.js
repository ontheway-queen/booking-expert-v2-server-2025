...
class PublicCommonController extends abstract_controller_1.default {
    constructor() {
        ...
        this.getSocialMedia = this.asyncWrapper.wrap({ bodySchema: this.commonValidator.getBanks }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _a = yield this.service.getSocialMedia(req), { code } = _a, rest = __rest(_a, ["code"]);
            res.status(code).json(rest);
        }));
        ...
        this.getSabreBooking = this.asyncWrapper.wrap({ paramSchema: this.commonValidator.singleParamStringValidator('pnr_code') }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _a = yield this.service.getSabreBooking(req), { code } = _a, rest = __rest(_a, ["code"]);
            res.status(code).json(rest);
        }));
    }
}
