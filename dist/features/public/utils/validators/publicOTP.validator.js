    ...
    constructor() {
        ...
        this.sendOtpInputValidator = joi_1.default.object({
            type: joi_1.default.string()
                .valid(constants_1.OTP_TYPES.reset_admin, constants_1.OTP_TYPES.verify_admin, constants_1.OTP_TYPES.reset_agent, constants_1.OTP_TYPES.verify_agent, constants_1.OTP_TYPES.reset_b2c, constants_1.OTP_TYPES.verify_b2c)
                .required()
                .messages({
