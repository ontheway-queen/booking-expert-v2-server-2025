...
class PublicEmailOTPValidator {
    constructor() {
        // send email otp input validator
        this.sendOtpInputValidator = joi_1.default.object({
            type: joi_1.default.string()
                .valid(constants_1.OTP_TYPES.reset_admin, constants_1.OTP_TYPES.reset_agent, constants_1.OTP_TYPES.reset_b2c, constants_1.OTP_TYPES.register_agent, constants_1.OTP_TYPES.register_b2c)
                .required()
                .messages({
...
exports.default = PublicEmailOTPValidator;
