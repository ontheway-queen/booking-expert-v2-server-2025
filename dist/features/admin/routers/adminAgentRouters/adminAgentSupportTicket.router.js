...
const adminAgentSupportTicket_controller_1 = require("../../controllers/adminAgentControllers/adminAgentSupportTicket.controller");
class AdminAgentSupportTicketRouter extends abstract_router_1.default {
    constructor() {
        super();
        this.controller = new adminAgentSupportTicket_controller_1.AdminAgentSupportTicketController();
        this.callRouter();
    }
    callRouter() {
        this.router
...
exports.default = AdminAgentSupportTicketRouter;
