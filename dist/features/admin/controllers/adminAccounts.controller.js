...
const adminAccounts_service_1 = require("../services/adminAccounts.service");
const adminAccounts_validator_1 = require("../utils/validators/adminAccounts.validator");
class AdminAccountsController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new adminAccounts_service_1.AdminAccountsService();
        this.validator = new adminAccounts_validator_1.AdminAccountsValidator();
...
exports.default = AdminAccountsController;
