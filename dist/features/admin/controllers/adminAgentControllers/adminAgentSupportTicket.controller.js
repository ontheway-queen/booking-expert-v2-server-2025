...
exports.AdminAgentSupportTicketController = void 0;
const abstract_controller_1 = __importDefault(require("../../../../abstract/abstract.controller"));
const adminAgentSupportTicket_service_1 = require("../../services/adminAgentServices/adminAgentSupportTicket.service");
const adminAgentSupportTicket_validator_1 = __importDefault(require("../../utils/validators/adminAgentValidators/adminAgentSupportTicket.validator"));
class AdminAgentSupportTicketController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new adminAgentSupportTicket_service_1.AdminAgentSupportTicketService();
        this.validator = new adminAgentSupportTicket_validator_1.default();
...
exports.AdminAgentSupportTicketController = AdminAgentSupportTicketController;
