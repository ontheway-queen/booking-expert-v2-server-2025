...
const adminDynamicFareSet_service_1 = __importDefault(require("../services/adminDynamicFareSet.service"));
const adminDynamicFareSet_validator_1 = require("../utils/validators/adminDynamicFareSet.validator");
class AdminDynamicFareSetController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new adminDynamicFareSet_service_1.default();
        this.validator = new adminDynamicFareSet_validator_1.AdminDynamicFareSetValidator();
        ...
        this.deleteSet = this.asyncWrapper.wrap({ paramSchema: this.commonValidator.singleParamNumValidator() }, (req, res) => __awaiter(this, void 0, void 0, function* () {
...
exports.default = AdminDynamicFareSetController;
