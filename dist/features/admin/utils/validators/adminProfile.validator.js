...
class AdminProfileValidator {
    constructor() {
        ...
        this.changePassword = joi_1.default.object({
            old_password: joi_1.default.string().required().trim().min(8).max(100),
            new_password: joi_1.default.string().required().trim().min(8).max(100),
        });
    }
}
exports.default = AdminProfileValidator;
