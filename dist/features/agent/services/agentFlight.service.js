    ...
    flightSearch(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                const agency_details = yield agencyModel.checkAgency({ agency_id: ref_id || agency_id });
                ...
                if (ref_id) {
                    markup_amount = yield lib_1.default.getSubAgentTotalMarkup({ trx, type: 'Flight', agency_id });
                    if (!markup_amount) {
                        return {
                            success: false,
                            code: this.StatusCode.HTTP_BAD_REQUEST,
    ...
    flightBooking(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                let status = directBookingPermission.booking_block
