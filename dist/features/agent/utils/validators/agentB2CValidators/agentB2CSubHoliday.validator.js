    ...
    constructor() {
        ...
        this.createHolidaySchema = joi_1.default.object({
            ...
            pricing: joi_1.default.alternatives()
                .try(this.createPricingSchema.required(), joi_1.default.string().custom((value, helpers) => {
                try {
...
exports.AgentB2CSubHolidayValidator = AgentB2CSubHolidayValidator;
