...
exports.AgentTravelerValidator = void 0;
    ...
    constructor() {
        ...
        this.update = joi_1.default.object({
            ...
            last_name: joi_1.default.string()
                ...
                .pattern(/^[a-zA-Z\s\-']+$/) // Allows letters, spaces, hyphens, apostrophes
                .pattern(/^(?!.*(.)\1{3})/), // Blocks >3 repeating chars
            type: joi_1.default.string().optional().valid("ADT", "C02", "C03", "C04", "C05", "C06", "C07", "C08", "C09", "C10", "C11", "INF"),
...
exports.AgentTravelerValidator = AgentTravelerValidator;
