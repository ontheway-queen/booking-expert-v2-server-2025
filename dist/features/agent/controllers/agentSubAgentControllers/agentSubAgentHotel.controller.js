...
exports.AgentSubAgentHotelController = void 0;
const abstract_controller_1 = __importDefault(require("../../../../abstract/abstract.controller"));
const agentSubAgentHotel_service_1 = require("../../services/agentSubAgentServices/agentSubAgentHotel.service");
const agentSubAgentHotel_validator_1 = __importDefault(require("../../utils/validators/agentSubAgentValidators/agentSubAgentHotel.validator"));
class AgentSubAgentHotelController extends abstract_controller_1.default {
    constructor() {
        super();
        this.validator = new agentSubAgentHotel_validator_1.default();
        this.services = new agentSubAgentHotel_service_1.AgentSubAgentHotelService();
...
exports.AgentSubAgentHotelController = AgentSubAgentHotelController;
