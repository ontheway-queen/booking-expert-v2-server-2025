...
exports.AgentB2CSubPaymentController = void 0;
const abstract_controller_1 = __importDefault(require("../../../../abstract/abstract.controller"));
const agentB2CSubPayment_service_1 = require("../../services/agentB2CServices/agentB2CSubPayment.service");
const agentB2CSubPayment_validator_1 = require("../../utils/validators/agentB2CValidators/agentB2CSubPayment.validator");
class AgentB2CSubPaymentController extends abstract_controller_1.default {
    constructor() {
        super();
        this.validator = new agentB2CSubPayment_validator_1.AgentB2CSubPaymentValidator();
        this.services = new agentB2CSubPayment_service_1.AgentB2CSubPaymentService();
