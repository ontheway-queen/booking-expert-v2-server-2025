...
const agentB2CSubHoliday_validator_1 = require("../../utils/validators/agentB2CValidators/agentB2CSubHoliday.validator");
const agentB2CSubHoliday_service_1 = require("../../services/agentB2CServices/agentB2CSubHoliday.service");
class AgentB2CSubHolidayController extends abstract_controller_1.default {
    constructor() {
        super();
        this.validator = new agentB2CSubHoliday_validator_1.AgentB2CSubHolidayValidator();
        this.service = new agentB2CSubHoliday_service_1.AgentB2CSubHolidayService();
...
exports.default = AgentB2CSubHolidayController;
