...
const agentFlight_service_1 = require("../services/agentFlight.service");
const agentFlight_validator_1 = __importDefault(require("../utils/validators/agentFlight.validator"));
class AgentFlightController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new agentFlight_service_1.AgentFlightService();
        this.validator = new agentFlight_validator_1.default();
