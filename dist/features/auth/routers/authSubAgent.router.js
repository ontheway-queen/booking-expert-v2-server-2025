...
const authSubAgent_controller_1 = __importDefault(require("../controllers/authSubAgent.controller"));
class AuthSubAgentRouter extends abstract_router_1.default {
    constructor() {
        super();
        this.controller = new authSubAgent_controller_1.default();
        this.callRouter();
    }
    callRouter() {
...
exports.default = AuthSubAgentRouter;
