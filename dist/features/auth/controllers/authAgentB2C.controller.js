...
const authAgentB2C_service_1 = __importDefault(require("../services/authAgentB2C.service"));
class AuthAgentB2CController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new authAgentB2C_service_1.default();
        ...
        this.register = this.asyncWrapper.wrap({ bodySchema: this.validator.agentB2CRegister }, (req, res) => __awaiter(this, void 0, void 0, function* () {
...
exports.default = AuthAgentB2CController;
