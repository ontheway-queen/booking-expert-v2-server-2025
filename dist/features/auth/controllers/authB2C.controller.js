...
const authB2C_service_1 = __importDefault(require("../services/authB2C.service"));
const authValidator_1 = __importDefault(require("../utils/validators/authValidator"));
class AuthB2CController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new authB2C_service_1.default();
...
exports.default = AuthB2CController;
