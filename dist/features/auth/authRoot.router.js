...
const authSubAgent_router_1 = __importDefault(require("./routers/authSubAgent.router"));
class AuthRootRouter {
    constructor() {
        ...
        this.authSubAgentRouter = new authSubAgent_router_1.default();
        this.callRouter();
    }
    callRouter() {
        // Agent auth routes
        ...
        this.Router.use('/sub-agent', new authChecker_1.default().whiteLabelAuthChecker, this.authSubAgentRouter.router);
