...
exports.AgentB2CSupportTicketController = void 0;
const abstract_controller_1 = __importDefault(require("../../../abstract/abstract.controller"));
const agentB2CSupportTicket_service_1 = require("../services/agentB2CSupportTicket.service");
const agentB2CSupportTicket_validator_1 = __importDefault(require("../utils/validators/agentB2CSupportTicket.validator"));
class AgentB2CSupportTicketController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new agentB2CSupportTicket_service_1.AgentB2CSupportTicketService();
        this.validator = new agentB2CSupportTicket_validator_1.default();
...
exports.AgentB2CSupportTicketController = AgentB2CSupportTicketController;
