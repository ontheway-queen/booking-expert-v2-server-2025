...
exports.AgentB2CHolidayController = void 0;
const abstract_controller_1 = __importDefault(require("../../../abstract/abstract.controller"));
const agentB2CHoliday_service_1 = require("../services/agentB2CHoliday.service");
const agentB2CHoliday_validator_1 = require("../utils/validators/agentB2CHoliday.validator");
class AgentB2CHolidayController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new agentB2CHoliday_service_1.AgentB2CHolidayService();
        this.validator = new agentB2CHoliday_validator_1.AgentB2CHolidayValidator();
...
exports.AgentB2CHolidayController = AgentB2CHolidayController;
