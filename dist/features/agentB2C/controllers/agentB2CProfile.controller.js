...
const agentB2CProfile_service_1 = __importDefault(require("../services/agentB2CProfile.service"));
const agentB2CProfile_validator_1 = require("../utils/validators/agentB2CProfile.validator");
class AgentB2CProfileController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new agentB2CProfile_service_1.default();
        this.validator = new agentB2CProfile_validator_1.AgentB2CProfileValidator();
        //get profile
...
exports.default = AgentB2CProfileController;
