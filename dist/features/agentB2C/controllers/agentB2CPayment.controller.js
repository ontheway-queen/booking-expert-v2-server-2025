...
const agentB2CPayment_validator_1 = __importDefault(require("../utils/validators/agentB2CPayment.validator"));
class AgentB2CPaymentController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new agentB2CPayment_service_1.default();
        this.validator = new agentB2CPayment_validator_1.default();
        ...
        this.getDepositRequest = this.asyncWrapper.wrap({ bodySchema: this.validator.getDeposit }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _a = yield this.service.getDepositRequest(req), { code } = _a, rest = __rest(_a, ["code"]);
            res.status(code).json(rest);
        }));
        ...
        this.getPaymentGatewayList = this.asyncWrapper.wrap(null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _a = yield this.service.getPaymentGatewayList(req), { code } = _a, rest = __rest(_a, ["code"]);
            res.status(code).json(rest);
        }));
