    ...
    searchHolidayPackage(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                const data = yield holidayPackageModel.getHolidayPackageList(Object.assign(Object.assign({}, query), { created_by: holidayConstants_1.HOLIDAY_CREATED_BY_AGENT, status: true, agency_id }), true);
                return {
                    success: true,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                const get_holiday_data = yield holidayPackageModel.getSingleHolidayPackage({
                    ...
                    holiday_for: constants_1.SOURCE_AGENT_B2C,
                    status: true,
                    agency_id,
                });
                if (!get_holiday_data) {
    ...
    bookHolidayPackage(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                //calculate the price
                const price_details = get_holiday_data.pricing.find((item) => item.price_for === constants_1.SOURCE_AGENT_B2C);
                if (!price_details) {
                    return {
                        success: false,
                ...
                const booking_body = Object.assign(Object.assign({}, body), { booking_ref, source_type: constants_1.SOURCE_AGENT_B2C, source_id: agency_id, user_id,
                    total_adult_price,
                    total_child_price,
                    total_markup,
...
exports.AgentB2CHolidayService = AgentB2CHolidayService;
