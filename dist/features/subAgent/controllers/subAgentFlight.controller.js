...
const subAgentFlight_service_1 = require("../services/subAgentFlight.service");
const subAgentFlight_validator_1 = __importDefault(require("../utils/validator/subAgentFlight.validator"));
class SubAgentFlightController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new subAgentFlight_service_1.SubAgentFlightService();
        this.validator = new subAgentFlight_validator_1.default();
        ...
        this.FlightSearchSSE = this.asyncWrapper.wrap({ querySchema: this.validator.flightSearchSSESchema }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const errorPayload = {
                    ...
                    error: Object.assign(Object.assign({ message: error.message, stack: error.stack, name: error.name }, (error.code && { code: error.code })), (error.response && { response: error.response })),
                };
        ...
        this.issueTicket = this.asyncWrapper.wrap({ bodySchema: this.validator.issueTicketSchema }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _a = yield this.service.issueTicket(req), { code } = _a, rest = __rest(_a, ["code"]);
            res.status(code).json(rest);
        }));
        this.cancelBooking = this.asyncWrapper.wrap({ paramSchema: this.commonValidator.singleParamNumValidator() }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _a = yield this.service.cancelBooking(req), { code } = _a, rest = __rest(_a, ["code"]);
            res.status(code).json(rest);
        }));
    }
}
exports.default = SubAgentFlightController;
