...
const subAgentConfig_service_1 = require("../services/subAgentConfig.service");
class SubAgentConfigController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new subAgentConfig_service_1.SubAgentConfigService();
        ...
        this.GetTermsAndConditionsPageData = this.asyncWrapper.wrap(null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _a = yield this.service.GetTermsAndConditionsPageData(req), { code } = _a, rest = __rest(_a, ["code"]);
            res.status(code).json(rest);
        }));
...
exports.default = SubAgentConfigController;
