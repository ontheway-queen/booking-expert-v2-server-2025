...
exports.SubAgentCVisaController = void 0;
const abstract_controller_1 = __importDefault(require("../../../abstract/abstract.controller"));
const subAgentVisa_service_1 = require("../services/subAgentVisa.service");
const subAgentVisa_validator_1 = require("../utils/validator/subAgentVisa.validator");
class SubAgentCVisaController extends abstract_controller_1.default {
    constructor() {
        super(...arguments);
        this.service = new subAgentVisa_service_1.subAgentVisaService();
        this.validator = new subAgentVisa_validator_1.SubAgentVisaValidator();
        //get all visa type
...
exports.SubAgentCVisaController = SubAgentCVisaController;
