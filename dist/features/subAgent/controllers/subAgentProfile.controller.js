...
const subAgentProf_validator_1 = __importDefault(require("../utils/validator/subAgentProf.validator"));
class SubAgentProfileController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new subAgentProfile_service_1.default();
        this.validator = new subAgentProf_validator_1.default();
        //get profile
...
exports.default = SubAgentProfileController;
