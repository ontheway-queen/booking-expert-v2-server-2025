...
const subAgentPayments_service_1 = require("../services/subAgentPayments.service");
const subAgentPayments_validator_1 = require("../utils/validator/subAgentPayments.validator");
class SubAgentPaymentsController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new subAgentPayments_service_1.SubAgentPaymentsService();
        this.validator = new subAgentPayments_validator_1.SubAgentPaymentsValidator();
        ...
        this.getSingleDepositRequest = this.asyncWrapper.wrap({ paramSchema: this.commonValidator.singleParamNumValidator() }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _a = yield this.service.getSingleDepositRequest(req), { code } = _a, rest = __rest(_a, ["code"]);
            res.status(code).json(rest);
        }));
...
exports.default = SubAgentPaymentsController;
