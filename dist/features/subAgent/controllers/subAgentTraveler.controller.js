...
const subAgentTraveler_service_1 = require("../services/subAgentTraveler.service");
const subAgentTraveler_validator_1 = __importDefault(require("../utils/validator/subAgentTraveler.validator"));
class SubAgentTravelerController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new subAgentTraveler_service_1.SubAgentTravelerService();
        this.validator = new subAgentTraveler_validator_1.default();
...
exports.default = SubAgentTravelerController;
