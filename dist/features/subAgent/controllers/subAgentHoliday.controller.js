...
exports.SubAgentHolidayController = void 0;
const abstract_controller_1 = __importDefault(require("../../../abstract/abstract.controller"));
const subAgentHoliday_validator_1 = require("../utils/validator/subAgentHoliday.validator");
const subAgentHoliday_service_1 = require("../services/subAgentHoliday.service");
class SubAgentHolidayController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new subAgentHoliday_service_1.SubAgentHolidayService();
        this.validator = new subAgentHoliday_validator_1.SubAgentHolidayValidator();
...
exports.SubAgentHolidayController = SubAgentHolidayController;
