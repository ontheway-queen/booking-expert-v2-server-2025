...
class SubAgentMainValidator {
    constructor() {
        // send email otp input validator
        this.sendOtpInputValidator = joi_1.default.object({
            type: joi_1.default.string()
                .valid(constants_1.OTP_TYPES.register_sub_agent, constants_1.OTP_TYPES.verify_sub_agent, constants_1.OTP_TYPES.reset_sub_agent)
                .required()
                .messages({
...
exports.default = SubAgentMainValidator;
