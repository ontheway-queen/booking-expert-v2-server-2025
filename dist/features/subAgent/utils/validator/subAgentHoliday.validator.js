    ...
    constructor() {
        ...
        this.holidayPackageBookingListFilterQuery = joi_1.default.object({
            status: joi_1.default.string()
                .optional()
                .valid(...Object.values(holidayConstants_1.HOLIDAY_BOOKING_STATUS)),
...
exports.SubAgentHolidayValidator = SubAgentHolidayValidator;
