...
class SubAgentFlightValidator {
    constructor() {
        ...
        this.flightSearchSSESchema = joi_1.default.object({
            ...
            auth_token: joi_1.default.string().required(),
        ...
        this.flightBookingPassengersSchema = joi_1.default.object({
            ...
            first_name: joi_1.default.string()
                ...
                .custom((value, helpers) => {
                if (lib_1.default.gibberishChecker(value)) {
                    return helpers.error('string.gibberish');
                }
                return value;
            }, 'Gibberish check')
                .messages({
                'string.pattern.base': 'Name must contain only letters, spaces, hyphens, and apostrophes.',
                'string.gibberish': 'Name appears to be invalid or gibberish.',
            })
                .required(),
...
exports.default = SubAgentFlightValidator;
