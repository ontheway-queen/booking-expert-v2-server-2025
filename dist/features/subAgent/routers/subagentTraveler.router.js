...
const subAgentTraveler_controller_1 = __importDefault(require("../controllers/subAgentTraveler.controller"));
class SubAgentTravelerRouter extends abstract_router_1.default {
    constructor() {
        super();
        this.controller = new subAgentTraveler_controller_1.default();
        this.callRouter();
    }
    callRouter() {
        this.router
...
exports.default = SubAgentTravelerRouter;
