...
const subAgentHoliday_controller_1 = require("../controllers/subAgentHoliday.controller");
class SubAgentHolidayRouter extends abstract_router_1.default {
    constructor() {
        super();
        this.controller = new subAgentHoliday_controller_1.SubAgentHolidayController();
        this.callRouter();
    }
    callRouter() {
...
exports.default = SubAgentHolidayRouter;
