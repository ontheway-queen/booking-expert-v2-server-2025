...
const subAgentAdministration_controller_1 = __importDefault(require("../controllers/subAgentAdministration.controller"));
class SubAgentAdministrationRouter extends abstract_router_1.default {
    constructor() {
        super();
        this.controller = new subAgentAdministration_controller_1.default();
        this.callRouter();
    }
    callRouter() {
        this.router
...
exports.default = SubAgentAdministrationRouter;
