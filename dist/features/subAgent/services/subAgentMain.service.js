...
exports.SubAgentMainService = void 0;
...
class SubAgentMainService extends abstract_service_1.default {
                ...
                try {
                    const send_email = yield emailSendLib_1.default.sendEmailAgent(trx, agency_id, {
                        ...
                        emailBody: (0, sendEmailOtpTemplate_1.sendEmailOtpTemplate)({
                            otp,
                            otpFor: OTP_FOR,
                            logo: siteData === null || siteData === void 0 ? void 0 : siteData.main_logo,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (otpValidation) {
                    ...
                    //--change it
                    let secret = config_1.default.JWT_SECRET_AGENT;
...
exports.SubAgentMainService = SubAgentMainService;
