...
const flightUtils_1 = __importDefault(
  require('../../../utils/lib/flight/flightUtils')
);
...
const sabreFlightSupport_service_1 = __importDefault(
  require('../../../utils/supportServices/flightSupportServices/sabreFlightSupport.service')
);
const wfttFlightSupport_service_1 = __importDefault(
  require('../../../utils/supportServices/flightSupportServices/wfttFlightSupport.service')
);
...
class AgentFlightService extends abstract_service_1.default {
      ...
      return this.db.transaction((trx) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          if (body.JourneyType === '3') {
            ...
            if (
              Number(body.JourneyType) !==
              body.OriginDestinationInformation.length
            ) {
              return {
                success: false,
                code: this.StatusCode.HTTP_BAD_REQUEST,
          ...
          if (
            !(agency_details === null || agency_details === void 0
              ? void 0
              : agency_details.flight_markup_set)
          ) {
            return {
              success: false,
              code: this.StatusCode.HTTP_BAD_REQUEST,
          ...
          if (agency_type === 'SUB AGENT') {
            ...
            if (!markup_amount) {
              return {
                ...
                code: this.StatusCode.HTTP_BAD_REQUEST,
                message:
                  'Markup information is empty. Contact with the authority',
              };
            }
          }
          ...
          if (sabre_supplier_id) {
            const sabreSubService = new sabreFlightSupport_service_1.default(
              trx
            );
          ...
          if (custom_supplier_id) {
            const customSubService = new wfttFlightSupport_service_1.default(
              trx
            );
      ...
      return this.db.transaction((trx) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          const OriginDestinationInformation =
            req.query.OriginDestinationInformation;
          ...
          yield (0,
          redis_1.setRedis)(search_id, { reqBody: body, response: responseData });
          const data = [];
          const sendResults = (apiName, fetchResults) =>
            __awaiter(this, void 0, void 0, function* () {
      ...
      return this.db.transaction((trx) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          const flightSupportService =
            new commonFlightSupport_service_1.CommonFlightSupportService(trx);
          ...
          if (data) {
            yield (0, redis_1.setRedis)(
              `${flightConstant_1.FLIGHT_REVALIDATE_REDIS_KEY}${flight_id}`,
              data
            );
            const { fare, modifiedFare } = data,
              restData = __rest(data, ['fare', 'modifiedFare']);
            const { vendor_price } = fare,
              restFare = __rest(fare, ['vendor_price']);
            return {
              success: true,
              message: 'Flight has been revalidated successfully!',
              data: Object.assign(Object.assign({}, restData), {
                fare: restFare,
              }),
              code: this.StatusCode.HTTP_OK,
            };
  ...
  flightBooking(req) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const preBookData = yield this.db.transaction((trx) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          if (!booking_confirm) {
            const price_changed =
              yield flightSupportService.checkBookingPriceChange({
                flight_id: body.flight_id,
          ...
          const bookingSupportService =
            new commonFlightBookingSupport_service_1.CommonFlightBookingSupportService(
              trx
            );
          const checkEligibilityOfBooking =
            yield bookingSupportService.checkEligibilityOfBooking({
              route: new flightUtils_1.default().getRouteOfFlight(
                data.leg_description
              ),
          ...
          const directBookingPermission =
            yield bookingSupportService.checkDirectFlightBookingPermission({
          ...
          const { booking_id, booking_ref } =
            yield bookingSupportService.insertFlightBookingData({
        ...
        __awaiter(this, void 0, void 0, function* () {
          try {
            if (booking_block === false) {
              if (data.api === flightConstant_1.SABRE_API) {
                const sabreSubService =
                  new sabreFlightSupport_service_1.default(trx);
          ...
          try {
            ...
            yield this.Model.ErrorLogsModel(trx).insertErrorLogs({
              ...
              message:
                'Error update booking or Email send after booking.' + err,
              url: '/flight/booking',
              user_id: user_id,
              source: 'AGENT',
              metadata: {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      return yield this.db.transaction((trx) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          const data = yield flightBookingModel.getFlightBookingList(
      ...
      return yield this.db.transaction((trx) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          const price_breakdown_data =
            yield flightPriceBreakdownModel.getFlightBookingPriceBreakdown(
              Number(id)
            );
          const segment_data = yield flightSegmentModel.getFlightBookingSegment(
            Number(id)
          );
          const traveler_data =
            yield flightTravelerModel.getFlightBookingTraveler(Number(id));
          const { vendor_fare, source_type } = booking_data,
            restData = __rest(booking_data, ['vendor_fare', 'source_type']);
          return {
            success: true,
            code: this.StatusCode.HTTP_OK,
            data: Object.assign(Object.assign({}, restData), {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      return yield this.db.transaction((trx) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          const get_travelers =
            yield bookingTravelerModel.getFlightBookingTraveler(Number(id));
          ...
          const agentBookingSubService =
            new agentFlightBookingSupport_service_1.AgentFlightBookingSupportService(
              trx
            );
          const payment_data =
            yield agentBookingSubService.getPaymentInformation({
          ...
          const flightSegment =
            yield flightSegmentsModel.getFlightBookingSegment(Number(id));
          const agentFlightBookingSupportService =
            new agentFlightBookingSupport_service_1.AgentFlightBookingSupportService(
              trx
            );
          const ticketIssuePermission =
            yield agentFlightBookingSupportService.checkAgentDirectTicketIssuePermission(
              {
                agency_id: agency_id,
          ...
          if (ticketIssuePermission.issue_block === true) {
            ...
            if (booking_data.api === flightConstant_1.SABRE_API) {
              const travelerSet = new Set(
                get_travelers.map((elem) => elem.type)
              );
          ...
          return {
            ...
            code: this.StatusCode.HTTP_BAD_REQUEST,
            message:
              'Cannot issue ticket for this booking. Contact support team.',
          };
        })
      );
    });
  ...
  cancelBooking(req) {
    return __awaiter(this, void 0, void 0, function* () {
      return yield this.db.transaction((trx) =>
        __awaiter(this, void 0, void 0, function* () {
          const { user_id, agency_id, agency_email, agency_logo } =
            req.agencyUser;
          const { id } = req.params; //booking id
          const flightBookingModel = this.Model.FlightBookingModel(trx);
          const booking_data = yield flightBookingModel.getSingleFlightBooking({
