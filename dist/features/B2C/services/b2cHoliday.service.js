...
exports.B2CHolidayService = void 0;
const abstract_service_1 = __importDefault(require("../../../abstract/abstract.service"));
const lib_1 = __importDefault(require("../../../utils/lib/lib"));
const customError_1 = __importDefault(require("../../../utils/lib/customError"));
const holidayConstants_1 = require("../../../utils/miscellaneous/holidayConstants");
const constants_1 = require("../../../utils/miscellaneous/constants");
class B2CHolidayService extends abstract_service_1.default {
    searchHolidayPackage(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                const holidayPackageModel = this.Model.HolidayPackageModel(trx);
                const query = req.query;
                const data = yield holidayPackageModel.getHolidayPackageList(Object.assign(Object.assign({}, query), { created_by: holidayConstants_1.HOLIDAY_CREATED_BY_ADMIN, holiday_for: constants_1.SOURCE_B2C, status: true }), true);
                return {
                    success: true,
    ...
    bookHolidayPackage(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                //calculate the price
                const price_details = get_holiday_data.pricing.find((item) => item.price_for === constants_1.SOURCE_B2C);
                if (!price_details) {
                    return {
                        success: false,
...
exports.B2CHolidayService = B2CHolidayService;
