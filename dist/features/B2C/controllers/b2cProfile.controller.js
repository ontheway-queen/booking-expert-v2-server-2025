...
const b2cProfile_validator_1 = __importDefault(require("../utils/validators/b2cProfile.validator"));
const b2cProfile_service_1 = __importDefault(require("../services/b2cProfile.service"));
class B2CProfileController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new b2cProfile_service_1.default();
        this.validator = new b2cProfile_validator_1.default();
        //get profile
...
exports.default = B2CProfileController;
