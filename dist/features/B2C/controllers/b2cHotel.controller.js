...
exports.B2CHotelController = void 0;
const abstract_controller_1 = __importDefault(require("../../../abstract/abstract.controller"));
const b2cHotel_service_1 = __importDefault(require("../services/b2cHotel.service"));
const b2cHotel_validator_1 = require("../utils/validators/b2cHotel.validator");
class B2CHotelController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new b2cHotel_service_1.default();
        this.validator = new b2cHotel_validator_1.B2CHotelValidator();
...
exports.B2CHotelController = B2CHotelController;
