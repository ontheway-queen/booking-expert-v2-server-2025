...
exports.B2CFlightController = void 0;
const abstract_controller_1 = __importDefault(require("../../../abstract/abstract.controller"));
const b2cFlight_service_1 = require("../services/b2cFlight.service");
...
class B2CFlightController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new b2cFlight_service_1.B2CFlightService();
        ...
        this.getFareRules = this.asyncWrapper.wrap({ querySchema: this.validator.flightRevalidateSchema }, (req, res) => __awaiter(this, void 0, void 0, function* () {
...
exports.B2CFlightController = B2CFlightController;
