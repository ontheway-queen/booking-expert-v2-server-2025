...
class HotelBookingModel extends schema_1.default {
    ...
    getAgentHotelBooking(_a) {
        return __awaiter(this, arguments, void 0, function* ({ source_type, filter, from_date, source_id, to_date, limit, skip, user_id, ref_agent_id, }, need_total = false) {
    ...
    getSingleHotelBooking(_a) {
        return __awaiter(this, arguments, void 0, function* ({ booking_id, source_type, source_id, user_id, ref_agent_id, }) {
