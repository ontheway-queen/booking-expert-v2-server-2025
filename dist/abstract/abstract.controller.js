...
const publicOTP_validator_1 = __importDefault(require("../features/public/utils/validators/publicOTP.validator"));
...
class AbstractController {
    constructor() {
        this.commonValidator = new publicOTP_validator_1.default();
