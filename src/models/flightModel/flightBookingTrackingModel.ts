...
import { IGetFlightBookingTrackingData, IGetFlightBookingTrackingListFilterQuery, IInsertFlightBookingTrackingPayload } from '../../utils/modelTypes/flightModelTypes/flightBookingTrackingModelTypes';
...
export default class FlightBookingTrackingModel extends Schema {
    ...
    public async getFlightBookingTracking(
        query: IGetFlightBookingTrackingListFilterQuery, is_total: boolean = false)
