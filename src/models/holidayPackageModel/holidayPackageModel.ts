...
import { HOLIDAY_CREATED_BY_ADMIN, HOLIDAY_FOR_AGENT, HOLIDAY_FOR_B2C, HOLIDAY_FOR_BOTH, VIEW_HOLIDAY_PACKAGE_CREATED_BY_ADMIN, VIEW_HOLIDAY_PACKAGE_CREATED_BY_AGENT } from '../../utils/miscellaneous/holidayConstants';
import Schema from '../../utils/miscellaneous/schema';
import { IGetHolidayPackageList, IGetHolidayPackageListFilterQuery, IGetSingleHolidayPackageData, IGetSingleHolidayPackageParams, IInsertHolidayPackagePayload, IUpdateHolidayPackagePayload } from '../../utils/modelTypes/holidayPackageModelTypes/holidayPackageModelTypes';
...
export default class HolidayPackageModel extends Schema {
    ...
    public async getHolidayPackageList(
        ...
        const view_name = query.created_by === HOLIDAY_CREATED_BY_ADMIN ? VIEW_HOLIDAY_PACKAGE_CREATED_BY_ADMIN : VIEW_HOLIDAY_PACKAGE_CREATED_BY_AGENT;
    ...
    public async getSingleHolidayPackage(where: IGetSingleHolidayPackageParams): Promise<IGetSingleHolidayPackageData | null> {
        const view_name = where.created_by === HOLIDAY_CREATED_BY_ADMIN ? VIEW_HOLIDAY_PACKAGE_CREATED_BY_ADMIN : VIEW_HOLIDAY_PACKAGE_CREATED_BY_AGENT;
