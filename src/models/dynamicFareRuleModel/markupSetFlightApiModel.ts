...
import {
  ICreateMarkupSetFlightApiPayload,
...
export default class MarkupSetFlightApiModel extends Schema {
  ...
  public async createMarkupSetFlightApi(
    payload: ICreateMarkupSetFlightApiPayload
  ): Promise<{ id: number }[]> {
  ...
  public async updateMarkupSetFlightApi(
    payload: IUpdateMarkupSetFlightApiPayload,
    id: number
  ) {
    return await this.db('markup_set_flight_api')
      .withSchema(this.DBO_SCHEMA)
