...
import {
  IGetSingleTravelerParams,
  IGetTravelerDataFilterQuery,
  IInsertTravelerPayload,
  ITraveler,
  IUpdateTravelerPayload,
} from '../../utils/modelTypes/travelerModelTypes/travelerModelTypes';
...
export default class TravelerModel extends Schema {
  ...
  public async getTravelerList(
    query: IGetTravelerDataFilterQuery,
