...
export default class AgentSubAgentService extends AbstractServices {
    ...
    public async createSubAgency(req: Request) {
        return this.db.transaction(async (trx) => {
            ...
            const sub_agent_no = await Lib.generateNo({ trx, type: GENERATE_AUTO_UNIQUE_ID.agent });
    ...
    public async getAllSubAgency(req: Request) {
        ...
        const data = await AgencyModel.getAgencyList({ ...query, ref_id: agency_id }, true);
    ...
    public async updateAgency(req: Request) {
        return this.db.transaction(async (trx) => {
            ...
            const { flight_markup_type, hotel_markup_type, flight_markup_mode, hotel_markup_mode, flight_markup, hotel_markup, ...rest } = req.body as IAgentUpdateSubAgencyPayload;
