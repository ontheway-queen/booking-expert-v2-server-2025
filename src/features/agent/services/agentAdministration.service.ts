...
import {
  ICreateAgentReqBody,
  ICreateAgentRoleReqBody,
  IGetAgentListReqQuery,
  IGetAgentRoleListReqQuery,
  IUpdateAgentRolePermissionsReqBody,
} from '../utils/types/agentAdministration.types';
import { IUpdateAgentReqBody } from '../utils/types/agentAdministration.types';
import {
...
export class AgentAdministrationService extends AbstractServices {
  constructor() {
    super();
  }
  ...
  public async createRole(req: Request) {
    return await this.db.transaction(async (trx) => {
      ...
      const { role_name, permissions } = req.body as ICreateAgentRoleReqBody;
  ...
  public async getRoleList(req: Request) {
    const { name, status } = req.query as IGetAgentRoleListReqQuery;
  ...
  public async updateRolePermissions(req: Request) {
    return await this.db.transaction(async (trx) => {
      ...
      const {
        ...
        role_name,
        status,
      } = req.body as IUpdateAgentRolePermissionsReqBody;
  ...
  public async getAllAgentUserList(req: Request) {
    ...
    const query = req.query as IGetAgentListReqQuery;
  ...
  public async updateAgencyUser(req: Request) {
    ...
    const { role_id, ...restBody } = req.body as IUpdateAgentReqBody;
