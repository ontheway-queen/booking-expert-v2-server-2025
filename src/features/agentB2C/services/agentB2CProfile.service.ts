...
import { IAgentB2CChangePasswordReqBody, IUpdateAgentB2CProfileReqBody } from '../utils/types/agentB2CProfile.types';
...
export default class AgentB2CProfileService extends AbstractServices {
    ...
    public async getProfile(req: Request) {
        return await this.db.transaction(async (trx) => {
            ...
            const checkAgentB2C = await AgencyB2CUserModel.checkUser({ id: user_id, agency_id });
    ...
    public async changePassword(req: Request) {
        ...
        await AgencyB2CUserModel.updateUser(
            { password_hash },
            user_id,
            agency_id
        );
