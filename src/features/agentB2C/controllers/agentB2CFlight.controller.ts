...
import { AgentB2CFlightService } from '../services/agentB2CFlight.service';
import AgentB2CFlightValidator from '../utils/validators/agentB2CFlight.validator';

export default class AgentB2CFlightController extends AbstractController {
  private service = new AgentB2CFlightService();
  private validator = new AgentB2CFlightValidator();
  constructor() {
    super();
  }
