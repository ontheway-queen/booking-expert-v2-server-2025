...
import SubAgentFlightController from '../controllers/subAgentFlight.controller';

export default class SubAgentFlightRouter extends AbstractRouter {
  private controller = new SubAgentFlightController();
  constructor() {
    super();
    this.callRouter();
  }
