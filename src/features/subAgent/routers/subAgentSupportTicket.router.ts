...
import { SubAgentSupportTicketController } from '../controllers/subAgentSupportTicket.controller';

export default class SubAgentSupportTicketRouter extends AbstractRouter {
  private controller = new SubAgentSupportTicketController();
  constructor() {
    super();
    this.callRouter();
  }
