...
export class SubAgentHotelService extends AbstractServices {
  ...
  public async hotelSearch(req: Request) {
    return this.db.transaction(async (trx) => {
      ...
      const { name, ...payload } = req.body as ISubAgentHotelSearchReqBody;
  ...
  public async hotelSearchHistory(req: Request) {
    ...
    const query = req.query as ISubAgencyGetHotelSearchHistoryReqQuery;
  ...
  public async hotelBooking(req: Request) {
    return this.db.transaction(async (trx) => {
      ...
      const body = req.body as ISubAgentHotelBookingReqBody;
  ...
  public async getHotelBooking(req: Request) {
    ...
    const { filter, from_date, limit, skip, to_date } =
      req.query as ISubAgencyGetHotelBookingQuery;
