...
import {
  ISubAgencyUserChangePassReqBody,
  IUpdateSubAgentProfileReqBody,
} from "../utils/types/subAgentProfile.types";
import { IUpdateAgencyUserPayload } from "../../../utils/modelTypes/agentModel/agencyUserModelTypes";

export default class SubAgentProfileService extends AbstractServices {
  constructor() {
    super();
  }
  ...
  public async updateProfile(req: Request) {
    return this.db.transaction(async (trx) => {
      ...
      const body = req.body as IUpdateSubAgentProfileReqBody;
  ...
  public async changePassword(req: Request) {
    ...
    const { new_password, old_password } =
      req.body as ISubAgencyUserChangePassReqBody;
    const agencyUserModel = this.Model.AgencyUserModel();
