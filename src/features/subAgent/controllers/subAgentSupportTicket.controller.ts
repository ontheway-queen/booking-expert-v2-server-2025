...
import SubAgentSupportTicketValidator from '../utils/validator/subAgentSupportTicket.validator';
import { SubAgentSupportTicketService } from '../services/subAgentSupportTicket.service';

export class SubAgentSupportTicketController extends AbstractController {
  private service = new SubAgentSupportTicketService();
  private validator = new SubAgentSupportTicketValidator();
  constructor() {
    super();
  }
