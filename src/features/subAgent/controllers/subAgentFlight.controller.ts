...
import { SubAgentFlightService } from '../services/subAgentFlight.service';
import SubAgentFlightValidator from '../utils/validator/subAgentFlight.validator';

export default class SubAgentFlightController extends AbstractController {
  private service = new SubAgentFlightService();
  private validator = new SubAgentFlightValidator();
  constructor() {
    super();
  }
