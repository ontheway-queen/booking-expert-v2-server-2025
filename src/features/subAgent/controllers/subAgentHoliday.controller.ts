...
import { SubAgentHolidayValidator } from '../utils/validator/subAgentHoliday.validator';
import { SubAgentHolidayService } from '../services/subAgentHoliday.service';

export class SubAgentHolidayController extends AbstractController {
  private service = new SubAgentHolidayService();
  private validator = new SubAgentHolidayValidator();
  constructor() {
    super();
  }
