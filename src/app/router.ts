...
import SubAgentRootRouter from '../features/subAgent/subAgentRoot.router';
...
export default class RootRouter {
  ...
  private subAgentRootRouter = new SubAgentRootRouter();
  ...
  private callV2Router() {
    ...
    this.v2Router.use(
      '/agent-b2c',
      this.authChecker.whiteLabelAuthChecker,
      this.agentB2CRootRouter.Router
    );
    ...
    this.v2Router.use(
      '/sub-agent',
      this.authChecker.whiteLabelAuthChecker,
      this.subAgentRootRouter.Router
    );
