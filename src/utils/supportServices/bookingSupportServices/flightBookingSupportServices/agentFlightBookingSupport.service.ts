...
import { IAgentUpdateDataAfterTicketIssue, ICheckAgentDirectTicketIssuePermissionPayload, IGetPaymentInformationReqBody } from "../../../supportTypes/bookingSupportTypes/flightBookingSupportTypes/agentFlightBookingTypes";
import { CUSTOM_API, FLIGHT_TICKET_IN_PROCESS, FLIGHT_TICKET_ISSUE, PARTIAL_PAYMENT_DEPARTURE_DATE, PARTIAL_PAYMENT_PERCENTAGE, PAYMENT_TYPE_PARTIAL } from "../../../miscellaneous/flightConstent";
import Lib from "../../../lib/lib";
import { GENERATE_AUTO_UNIQUE_ID, INVOICE_REF_TYPES, SOURCE_ADMIN, SOURCE_AGENT, SOURCE_AGENT_B2C, SOURCE_B2C } from "../../../miscellaneous/constants";
...
export class AgentFlightBookingSupportService extends AbstractServices {
    ...
    public async updateDataAfterTicketIssue(payload: IAgentUpdateDataAfterTicketIssue) {
        //update booking
        ...
        tracking_data.push({
            ...
            description: `Ticket ${payload.status === FLIGHT_TICKET_IN_PROCESS ? 'has been issued' : 'is in process'}. Issued by ${payload.issued_by_type}`,
        });
