...
export class CommonFlightBookingSupportService extends AbstractServices {
    ...
    public async insertFlightBookingData(payload: IInsertFlightBookingDataPayload) {
        ...
        const booking_ref = await Lib.generateNo({ trx: this.trx, type: payload.type });
        ...
        await flightBookingPriceBreakdownModel.insertFlightBookingPriceBreakdown(passenger_fare);
    ...
    private getBookingMarkupDetails(discount: number, convenience_fee: number): {
