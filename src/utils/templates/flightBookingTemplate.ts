...
interface IEmailFlightBookingTemplate {
...
export const flightBookingBodyTemplate = (payload: IEmailFlightBookingTemplate) => {
  ...
  type BookingStatus = "BOOKED" | "PENDING" | "BOOKING IN PROCESS";
...
export const flightBookingPdfTemplate = (payload: {
  booking: IGetSingleFlightBookingData;
